...
const APP_STORE_URL = "https://apps.apple.com/us/app/%D8%A3%D8%B0%D9%83%D8%A7%D8%B1%D9%8A-athkari/id6758462687";
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="hidden md:flex items-center justify-center px-4 py-2 text-sm font-bold text-white bg-primary hover:bg-primary-dark rounded-lg transition-all duration-200 shadow-[0_0_15px_rgba(48,110,232,0.3)]"
              >
                جرب التطبيق
              </a>
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-right gap-6 max-w-2xl lg:w-1/2 mt-10 lg:mt-0 order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="lg:hidden flex items-center justify-center px-6 py-3.5 text-base font-bold text-white bg-primary hover:bg-primary-dark rounded-xl transition-all duration-200 w-full sm:w-auto shadow-[0_4px_14px_rgba(48,110,232,0.4)]"
              >
                جرب التطبيق الآن
              </a>
            </div>
