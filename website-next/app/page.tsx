    ...
    <>
        ...
        <div className="relative z-10 container mx-auto px-4 flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20 h-full flex-grow">
          <div className="flex flex-col items-center lg:items-start text-center lg:text-right gap-6 max-w-2xl lg:w-1/2 mt-10 lg:mt-0 order-2 lg:order-1">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm">
              ...
              <span className="text-xs font-medium text-primary-100">الإصدار الجديد متاح الآن</span>
            </div>
            <h1 className="font-display font-black text-4xl sm:text-5xl lg:text-7xl leading-[1.2] text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-400 drop-shadow-sm">
              رفيقك في كل <br /> <span className="text-primary">أوقاتك وعبادتك</span>
            </h1>
            <p className="text-gray-400 text-lg sm:text-xl font-light leading-relaxed max-w-lg font-body">
              تطبيق "أذكاري" يجمع لك الأذكار، مواقيت الصلاة، وتتبع الصيام في تصميم عصري وهادئ يعينك على ذكر الله.
            </p>
          ...
          <div className="relative w-full lg:w-1/2 h-[600px] sm:h-[700px] flex items-center justify-center lg:justify-end order-1 lg:order-2 perspective-1000">
            {/* Back Phone (Library View) */}
            <div className="absolute top-0 left-4 sm:left-12 lg:-left-4 w-[280px] sm:w-[300px] h-[580px] sm:h-[620px] bg-[#111] rounded-[40px] border-[6px] border-[#2d2d2d] shadow-2xl transform scale-90 -rotate-6 translate-y-8 opacity-80 z-10 transition-transform duration-500 hover:scale-95 hover:z-30 hover:opacity-100 hover:rotate-0">
            ...
            <div className="absolute top-4 right-4 sm:right-12 lg:right-4 w-[280px] sm:w-[300px] h-[580px] sm:h-[620px] bg-[#111] rounded-[40px] border-[6px] border-[#2d2d2d] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.6)] z-20">
      ...
      <section id="features" className="relative py-24 bg-[#0a0f16] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2 className="font-display font-bold text-3xl sm:text-4xl text-white mb-4">مصمم للمسلم المعاصر</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">جمعنا لك كل ما تحتاجه في تطبيق واحد بتصميم يراعي خصوصيتك وروحانيتك.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-colors">
              ...
              <h3 className="font-display font-bold text-xl text-white mb-2">الأذكار اليومية</h3>
              <p className="text-sm text-gray-400">عدادات ذكية لأذكار الصباح والمساء والنوم مع تتبع التقدم.</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-colors">
              ...
              <h3 className="font-display font-bold text-xl text-white mb-2">مواقيت الصلاة</h3>
              <p className="text-sm text-gray-400">مواقيت دقيقة حسب موقعك باستخدام تقويم أم القرى وغيرها.</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-colors">
              ...
              <h3 className="font-display font-bold text-xl text-white mb-2">تتبع الصيام</h3>
              <p className="text-sm text-gray-400">مواعيد الإفطار والسحور، وتذكير بالأيام البيض وصيام التطوع.</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-colors">
              <div className="w-12 h-12 rounded-xl bg-emerald-500/20 flex items-center justify-center text-emerald-400 mb-4">
                <span className="material-symbols-outlined">book_2</span>
              </div>
              <h3 className="font-display font-bold text-xl text-white mb-2">حصن المسلم</h3>
              <p className="text-sm text-gray-400">مكتبة شاملة من الأدعية الصحيحة لكل موقف في حياتك.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="gallery" className="py-24 bg-[#05080c] border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-display font-bold text-3xl sm:text-4xl text-white mb-4">واجهة بصرية مريحة</h2>
            <p className="text-gray-400">استمتع بتجربة مستخدم سلسة وهادئة.</p>
          </div>
